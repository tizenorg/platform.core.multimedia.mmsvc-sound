...
#ifndef __MUSE_SOUND_MSG_H__
#define __MUSE_SOUND_MSG_H__
...
/**
 * @brief Definition for the module parameter.
 */
#define PARAM_MODULE        "module"
...
/**
 * @brief Definition for the stream_type parameter.
 */
#define PARAM_STREAM_TYPE        "stream_type"

/**
 * @brief Definition for the stream_id parameter.
 */
#define PARAM_STREAM_ID        "stream_id"
